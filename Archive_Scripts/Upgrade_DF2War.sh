...
echo yes | cp -fru "$Compare_War_location/New_War/branding/." "$Compare_War_location/DF_WAR_Struct/branding/"
...
if [ "$word" == "lib" ]; then
    echo "Copying $word"
	echo yes | cp -fru "$Compare_War_location/New_War/WEB-INF/$word/." "$Compare_War_location/DF_WAR_Struct/WEB-INF/$word"
else
   echo "Copying $word"
   echo yes | cp -fru "$Compare_War_location/New_War/$word/." "$Compare_War_location/DF_WAR_Struct/$word"
fi
done
...
if [ "$word" == "lib" ]; then
    echo "Copying $word"
	echo yes | cp -fru "$Compare_War_location/DF_WAR_Struct/WEB-INF/$word/." "$SYNERGY_HOME/WEB-INF/$word/"
else
   echo "Copying $word"
   echo yes | cp -fru "$Compare_War_location/DF_WAR_Struct/$word/." "$SYNERGY_HOME/$word/"
fi
done
#*******************************************************************#
